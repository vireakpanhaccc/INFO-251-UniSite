...
const majors = [
  {
    ...
    universities: ["uni-001", "uni-002", "uni-003", "uni-004", "uni-005"],
    minSalary: 5000,
    maxSalary: 15000,
    minDemand: 200,
    typicalCareers: ["Software Developer", "Data Scientist", "Systems Analyst"],
    averageSalary: 8500,
    requirements: ["Strong foundation in mathematics", "Proficiency in programming languages", "Analytical thinking skills"],
    duration: "4 years",
    scholarshipsID: [1, 2, 3, 4],
    universitiesID: ["uni-001", "uni-002", "uni-003", "uni-004", "uni-005"],
    keywords: ["programming", "software", "AI", "data"],
    description: "Study of computers, algorithms and computational systems. Prepares graduates for software development, data science and research.",
    last_updated: "2024-06-01"
  },
  {
    _id: "major_102",
    ...
    universities: ["uni-001", "uni-005", "uni-007"],
    minSalary: 3000,
    maxSalary: 9000,
    minDemand: 150,
    typicalCareers: ["Business Manager", "Marketing Specialist", "Operations Analyst"],
    averageSalary: 5200,
    requirements: ["Basic numeracy", "Communication skills"],
    duration: "3-4 years",
    scholarshipsID: [1, 2, 3, 4],
    universitiesID: ["uni-001", "uni-005", "uni-007"],
    keywords: ["management", "marketing", "finance"],
    description: "Focus on business operations, management, marketing and finance. Equips students with practical management and leadership skills.",
    last_updated: "2024-06-01"
  },
  {
    _id: "major_103",
    ...
    level: ["Bachelor's", "Master's"],
    universities: ["uni-003", "uni-009"],
    minSalary: 3500,
    maxSalary: 11000,
    minDemand: 80,
    typicalCareers: ["Structural Engineer", "Site Engineer", "Project Manager"],
    averageSalary: 6000,
    requirements: ["Strong mathematics", "Physics foundation"],
    duration: "4 years",
    scholarshipsID: [2, 3, 4],
    universitiesID: ["uni-003", "uni-009"],
    keywords: ["infrastructure", "construction", "design"],
    description: "Design and construction of infrastructure including buildings, roads and bridges. Emphasis on structural design and project management.",
    last_updated: "2024-06-01"
  },
  {
    _id: "major_104",
    ...
    level: ["Bachelor's", "Master's"],
    universities: ["uni-002", "uni-006", "uni-009"],
    minSalary: 2500,
    maxSalary: 8000,
    minDemand: 120,
    typicalCareers: ["Accountant", "Auditor", "Tax Consultant"],
    averageSalary: 4800,
    requirements: ["Numeracy", "Attention to detail"],
    duration: "3-4 years",
    scholarshipsID: [2, 3, 4],
    universitiesID: ["uni-002", "uni-006", "uni-009"],
    keywords: ["finance", "taxation", "auditing"],
    description: "Focus on financial reporting, auditing and taxation. Prepares students for professional accounting qualifications.",
    last_updated: "2024-06-01"
  },
  {
    _id: "major_105",
    ...
    level: ["Bachelor's", "Master's"],
    universities: ["uni-001", "uni-003", "uni-004"],
    minSalary: 3200,
    maxSalary: 12000,
    minDemand: 180,
    typicalCareers: ["Network Engineer", "Database Administrator", "IT Support Specialist"],
    averageSalary: 5800,
    requirements: ["Basic programming", "Interest in networks and systems"],
    duration: "3-4 years",
    scholarshipsID: [1, 2, 3, 4],
    universitiesID: ["uni-001", "uni-003", "uni-004"],
    keywords: ["networks", "databases", "cybersecurity"],
    description: "Study of computer systems, networking, databases and IT infrastructure. Prepares graduates for technical IT roles.",
    last_updated: "2024-06-01"
  },
  {
    _id: "major_106",
    ...
    level: ["Bachelor's", "Master's"],
    universities: ["uni-005", "uni-007", "uni-010"],
    minSalary: 2400,
    maxSalary: 9000,
    minDemand: 140,
    typicalCareers: ["Marketing Manager", "Brand Strategist", "Digital Marketer"],
    averageSalary: 4700,
    requirements: ["Creativity", "Communication skills"],
    duration: "3-4 years",
    scholarshipsID: [2, 4],
    universitiesID: ["uni-005", "uni-007", "uni-010"],
    keywords: ["advertising", "branding", "digital marketing"],
    description: "Focus on market research, branding and promotional strategies, with growing emphasis on digital marketing and analytics.",
    last_updated: "2024-06-01"
  },
  {
    _id: "major_107",
    ...
    level: ["Bachelor's", "Master's"],
    universities: ["uni-003", "uni-006"],
    minSalary: 3300,
    maxSalary: 13000,
    minDemand: 90,
    typicalCareers: ["Mechanical Engineer", "Design Engineer", "Maintenance Engineer"],
    averageSalary: 6100,
    requirements: ["Mechanics", "Mathematics"],
    duration: "4 years",
    scholarshipsID: [2, 3, 4],
    universitiesID: ["uni-003", "uni-006"],
    keywords: ["machines", "thermodynamics", "manufacturing"],
    description: "Design, analysis and manufacturing of mechanical systems. Includes thermodynamics, materials and CAD design.",
    last_updated: "2024-06-01"
  },
  {
    _id: "major_108",
    ...
    level: ["Bachelor's", "Master's"],
    universities: ["uni-002", "uni-009", "uni-010"],
    minSalary: 2800,
    maxSalary: 12000,
    minDemand: 110,
    typicalCareers: ["Financial Analyst", "Investment Banker", "Portfolio Manager"],
    averageSalary: 6400,
    requirements: ["Numeracy", "Analytical skills"],
    duration: "3-4 years",
    scholarshipsID: [2, 3, 4],
    universitiesID: ["uni-002", "uni-009", "uni-010"],
    keywords: ["investment", "banking", "financial analysis"],
    description: "Study of financial markets, investment strategies and corporate finance. Prepares students for roles in banking and financial services.",
    last_updated: "2024-06-01"
  },
  {
    _id: "major_109",
    ...
    maxSalary: 12500,
    minDemand: 95,
    typicalCareers: ["Electrical Engineer", "Power Systems Engineer", "Control Systems Engineer"],
    averageSalary: 6200,
    ...
    description: "Study of electrical systems, electronics and signal processing. Covers power systems, controls and embedded electronics.",
    last_updated: "2024-06-01"
  },
  {
    _id: "major_110",
    ...
    level: ["Bachelor's", "Master's"],
    universities: ["uni-005", "uni-007"],
    minSalary: 2200,
    maxSalary: 7000,
    minDemand: 100,
    typicalCareers: ["HR Manager", "Recruitment Specialist", "Training and Development Officer"],
    averageSalary: 4200,
    requirements: ["Communication", "Interpersonal skills"],
    duration: "3-4 years",
    scholarshipsID: [],
    universitiesID: ["uni-005", "uni-007"],
    keywords: ["recruitment", "training", "employee relations"],
    description: "Focus on recruitment, training, performance management and employee relations within organizations.",
    last_updated: "2024-06-01"
  }
];
