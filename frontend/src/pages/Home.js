  ...
  el.innerHTML = `
    ...
    <div class="home-content flex flex-col gap-5 py-5 px-[5%]">
      ...
      <div class="home-search-bar w-full flex justify-center mb-6 h-10 text-xs md:text-md">
        <input class="flex-1 max-w-2xl h-10 border border-gray-400 rounded-l-3xl pl-4" type="text" placeholder="${t('search_placeholder')}">
        <button class="bg-[#2c3e50ec] border border-[#2c3e50ec] text-white px-4 md:px-8 rounded-r-3xl hover:bg-[#2c3e50] active:brightness-80">${t('search')}</button>
      </div>
